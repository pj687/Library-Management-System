...
function findBookById(id,doname) {
    ...
    $.get(url, function (response) {
        ...
        if(doname=='edit'){
            $("#ebid").val(response.data.book_id);
            $("#ebname").val(response.data.book_name);
            $("#ebisbn").val(response.data.book_isbn);
            $("#ebpress").val(response.data.book_press);
            $("#ebauthor").val(response.data.book_author);
            $("#ebpagination").val(response.data.book_pagination);
            $("#ebprice").val(response.data.book_price);
            $("#ebstatus").val(response.data.book_status);
        }
        //如果是借阅图书，将获取的图书信息回显到借阅的窗口中
        if(doname=='borrow'){
            $("#savemsg").attr("disabled",true)
            $("#time").val("");
            $("#bid").val(response.data.book_id);
            $("#bname").val(response.data.book_name);
            $("#bisbn").val(response.data.book_isbn);
            $("#bpress").val(response.data.book_press);
            $("#bauthor").val(response.data.book_author);
            $("#bpagination").val(response.data.book_pagination);
        }
    })
}
