                ...
                <tr>
                    ...
                    <td class="text-center">
                        <c:if test="${book.book_status ==1}">
                            <button type="button" class="btn bg-olive btn-xs" onclick="returnBook(${book.book_id})">归还
                            </button>
                        </c:if>
                        <c:if test="${book.book_status ==2}">
                            <button type="button" class="btn bg-olive btn-xs" disabled="true">归还中</button>
                            <c:if test="${USER_SESSION.role =='ADMIN'}">
                                <button type="button" class="btn bg-olive btn-xs" onclick="returnConfirm(${book.book_id})">
                                    归还确认
                                </button>
                            </c:if>
                        </c:if>
